      ...
      <SidebarBody>
        ...
        <Accordion title="Woher kommen die Daten?">
          <p className="text-sm pb-2">
            Diese Anwendung basiert komplett auf offenen Daten. Die gezeigten
            Weihnachtsmärkte stammen aus dem Datensatz{' '}
            <a
              target="blank"
            ...
            , der jährlich von der Senatsverwaltung für Wirtschaft, Energie und
            Betriebe bereitgestellt wird. Dadurch sind nur die der
            Senatsverwaltung gemeldeten Märkte aufgeführt und es besteht kein
            Anspruch auf Vollständigkeit. Weiterhin liegen in der Karte{' '}
            <a
              target="blank"
            ...
            , die sich ebenfalls im Berliner Open Data Portal befinden und
            regelmäßig durch die Senatsverwaltung für Umwelt, Mobilität,
            Verbraucher- und Klimaschutz aktualisiert werden. Für die
            Identifizierung der nahelegenen{' '}
            <a
              target="blank"
            ...
            Haltestellen liegen werden entsprechend bei der Filterung “Kurze
            Wege” ausgegeben. Die verarbeiteten Daten und die Skripte zur
        ...
        <Accordion title="Was ist Open Data?">
          <p className="text-sm pb-2">
            ...
            ermöglicht auch Analysen und Anwendungen wie diese, um den Alltag
            angenehmer zu machen. Deshalb unterstützt die{' '}
            <a
              target="blank"
        ...
        <Accordion title="Wie kann ich mitmachen?">
          <p className="text-sm pb-2">
            Du möchtest aktiv werden und dazu beitragen, dass der
            Weihnachtsmarkt-Finder im besten Glanz erscheint? Der Code ist{' '}
            <a
              target="blank"
              href="https://github.com/technologiestiftung/weihnachtsmarktkarte"
              className="text-primary"
            ...
            und jede:r kann nutzen. So kannst du das Projekt duplizieren und
            selbst weiterentwickeln oder du machst direkt Vorschläge für
            Verbesserungen und neue Funktionen. Sicher ist dir auch aufgefallen,
            dass viele Weihnachtsmärkte lediglich ein Platzhalter-Bild haben.
            Dies liegt daran, dass wir nur auf Bilder zurückgreifen wollen, die
            in Wikimedia Commons liegen, dem zentralen und offenen Medienarchiv.
            Also knips ein Bild von deinem nächsten Weihnachtsmarktbesuch und
        ...
        <Accordion title="Was ist mit anderen Städten?">
          <p className="text-sm pb-2">
            Der “Berliner Weihnachtsmarkt-Finder” ist ein Open-Source-Projekt
            und läuft unter einer MIT Lizenz. Dementsprechend kann die Idee,
            aber auch der Quellcode für die Umsetzung in anderen Städten
            kostenlos genutzt, angepasst und weiterentwickelt werden. Wenn Du
            dich dafür interessierst, schau gerne in unserem{' '}
            <a
              target="blank"
              href="https://github.com/technologiestiftung/weihnachtsmarktkarte"
              className="text-primary"
        ...
        <Accordion title="Über uns">
          <>
            <p className="text-sm pb-2">
              ...
              in Zusammenarbeit mit dem CityLAB Berlin. Die ODIS wird von der
              ...
              <a href="mailto:odis@ts.berlin" className="text-primary">
                odis@ts.berlin
              </a>
              .
            </p>
        ...
        <Accordion title="I don’t speak German: What's going on here?">
          <p className="text-sm pb-2">
            The Berlin Christmas Market Finder shows all of Berlin’s Christmas
            markets embedded in an interactive map of the city. You can filter
            the markets by date and attributes like free entry, themed markets
            with special attractions or proximity to public transport. Once you
            have found a Christmas market, you can also share it with your
            friends and colleagues. Based itself on open data, this application
            demonstrates the importance and usefulness of opening the data held
            by Berlin’s public administration. Beyond creating transparency and
            openness, it allows users to explore the city and come together to
            spread the Christmas cheer! You can find more open data in the{' '}
            <a
              target="blank"
              href="https://daten.berlin.de"
              className="text-primary"
